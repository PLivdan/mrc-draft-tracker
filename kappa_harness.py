...
for kappa, expo, label in [(4.0, True, "EXPOSURE k=4"), (16.0, True, "EXPOSURE k=16"),
                           (16.0, False, "CLASSIC k=16"), (64.0, False, "CLASSIC k=64")]:
    set_ban_alpha(kappa, expo)
    run(False, label)
print("KAPPA_DONE", flush=True)
